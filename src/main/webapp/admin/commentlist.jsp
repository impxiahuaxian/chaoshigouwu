                                ...
                                <div class='responsive-table'>
                                    <div class='scrollable-area'>
                                        <table class='data-table table table-bordered table-striped' style="margin-bottom:0px;">
                                            ...
                                            <tr>
                                                <td>${comment.pt.productname}</td>
                                                <td>${comment.content}</td>
                                                <td>${comment.pf}</td>
                                                <td>${comment.member.nickname}</td>
                                                <td>
                                                    <div class='text-right'>
                                                        <a class='btn btn-danger btn-mini' href='commentDel?id=${comment.id}'>
                                            ...
                                            <tr>
                                                <td colspan="9">
                                                    ...
                                                    <a href="commentList?pageNum=1&key=${key}">首页</a>
                                                    <a href="commentList?pageNum=${pageInfo.hasPreviousPage==false?1:pageInfo.prePage}&key=${key}">上一页</a>
                                                    <a href="commentList?pageNum=${pageInfo.hasNextPage==false?pageInfo.pages:pageInfo.nextPage}&key=${key}">下一页</a>
                                                    <a href="commentList?pageNum=${pageInfo.pages}&key=${key}">尾页</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
