                                ...
                                <div class='responsive-table'>
                                    <div class='scrollable-area'>
                                        <table class='data-table table table-bordered table-striped' style="margin-bottom:0px;">
                                            ...
                                            <tr>
                                                <td>${dingdanmsg.product.productname}</td>
                                                <td>
                                                    <c:choose>
                                                        <c:when test="${dingdanmsg.product.tjprice ne null and dingdanmsg.product.tjprice gt 0}">
                                                            <font style="color:gray;font-weight: bolder"><s>${dingdanmsg.product.price} </s></font>&nbsp;&nbsp;<font style="font-weight: bolder;">${dingdanmsg.product.tjprice}</font>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <font style="font-weight: bolder;">${dingdanmsg.product.price}</font>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </td>
                                                <td>${dingdanmsg.num}</td>
                                                <td>${dingdanmsg.xjtotal}</td>
                                            </tr>
                                            </c:forEach>
                                            </tbody>
                                        </table>
